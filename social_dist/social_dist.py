...
try:
    ...
    protopath = "/home/foss/loitring/model_files/MobileNetSSD_deploy.prototxt.txt"
    modelpath = "/home/foss/loitring/model_files/MobileNetSSD_deploy.caffemodel"
...
def main():
    ...
    while True:
        ...
        #print on the frame
        lpc_txt = "Current count: {}".format(person_count)
